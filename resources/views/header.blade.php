    ...
    <div id="em-mheader" class="visible-xs container">
        <div id="em-mheader-top" class="row">
            <div id="em-mheader-logo" class="col-xs-4">
                <div class="em-logo"><a href="#" title="Game World Commerce" class="logo"><strong>Game World Commerce</strong><img src="source/images/logo_small.png" alt="Game World Commerce" /></a>
                </div>
            </div>
            <div class="col-xs-20">
                            ...
                            <div class="em-language-currency row">
                                <div class="col-sm-24">
                                    <div class="form-language em-language-style-mobile">
                                        <ul>
                                            <li class="selected">
                                                <a href="#" title="English"> <img alt="english" src="source/images/language/english.png" /> </a>
                                            </li>
                                            <li class="">
                                                <a href="#" title="French"> <img alt="french" src="source/htimages/language/french.html" /> </a>
                                            </li>
                                        </ul>
                                    </div><!-- /.form-language -->
                                                            ...
                                                            <li class="menu-item-text menu-item-depth-1  ">
                                                                <ul class="em-catalog-navigation vertical">
                                                                    ...
                                                                    <li class="level0 nav-7">
                                                                        <a href="#"> <span>Game World</span> </a>
                                                                    </li><!-- /.menu-item-vbox -->
                                                                    <li class="level0 nav-8">
                                                                        <a href="#"> <span>Game World &amp; Outdoor</span> </a>
                                                                    </li><!-- /.menu-item-vbox -->
                                                                    ...
                                                                    <li class="level0 nav-11">
                                                                        <a href="#"> <span>Home Game World</span> </a>
                                                                    </li><!-- /.menu-item-vbox -->
    ...
    <div class="hidden-xs em-header-style29">
                            ...
                            <div class="em-language-currency f-left">
                                <div class="form-language toolbar-switch em-language-style01">
                                    <div class="toolbar-title">
                                        <select id="em-hoverUl-language" title="Your Language" onchange="window.location.href=this.value">
                                            <option value="furniture_eng" selected="selected">English</option>
                                            <option value="furniture_fre">French</option>
                                        </select>
                                    </div>
                                </div>
        ...
        <div class="em-header-middle">
            <div class="container em-menu-fix-pos">
                <div class="row">
                    <div class="col-sm-24">
                        <div class="em-logo f-left"><a href="#" title="Game World Commerce" class="logo"><strong>Game World Commerce</strong><img class="retina-img" src="source/images/logo.png" alt="Game World Commerce" /></a>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-24">
                        <div class="em-logo-sticky f-left">
                            <a href="#" title="Game World Commerce" class="logo"><img src="images/logo_small.png" alt="Game World Commerce" />
                            </a>
                        </div>
                                    ...
                                    <div class="megamenu-wrapper wrapper-11_9908">
                                        <div class="em_nav" id="toogle_menu_11_9908">
                                            <ul class="hnav effect-menu">
                                                <li class="menu-item-link menu-item-depth-0 menu_custom menu_col6 menu-item-parent">
                                                    <a class="em-menu-link" href="#"> <span> Category </span> </a>
                                                    <ul class="menu-container">
                                                                        ...
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <div class="store-view">
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                        <div>
                                                                                            <a title="Fashion Store" href="#"><img class="img-responsive" src="images/storeview/main_fashion_store.jpg" alt="Fashion Store" />
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                        <div>
                                                                                            <a title="Furniture Store" href="#"><img class="img-responsive" src="images/storeview/furniture_store.jpg" alt="Furniture Store" />
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                        <div>
                                                                                            <a title="Game World Store" href="#"><img class="img-responsive" src="images/storeview/baby_store.jpg" alt="Game World Store" />
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <p class="h5"><a href="#">Game World Store</a>
                                                                                    </p>
                                                                                </div>
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                        <div>
                                                                                            <a title="Game World Store" href="#"><img class="img-responsive" src="images/storeview/garden_store.jpg" alt="Game World Store" />
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <p class="h5"><a href="#">Game World Store</a>
                                                                            ...
                                                                            <div class="store-view" style="padding-top:15px">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                        <div>
                                                                                            <a title="Game World Store" href="#"><img class="img-responsive" src="images/storeview/sport_store.jpg" alt="Game World Store" />
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <p class="h5"><a href="#">Game World Store</a>
                                                                            ...
                                                                            <div class="store-view" style="padding-top:15px">
                                                                                ...
                                                                                <div class="col-sm-4">
                                                                                    <div class="effect03">
                                                                                        <div>
                                                                                            <a title="Game World Store" href="#"><img class="img-responsive" src="images/storeview/smartphone_store.jpg" alt="Game World Store" />
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                                    <p class="h5"><a href="#">Game World Store</a>
                                                                    ...
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                ...
                                                                                <p class="h5"><a href="category-one-column.html">One Column</a>
                                                                                </p>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                    ...
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                ...
                                                                                <p class="h5"><a href="category-two-columns-left.html">Two Columns Left</a>
                                                                                </p>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                    ...
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                ...
                                                                                <p class="h5"><a href="category-two-columns-right.html">Two Columns Right</a>
                                                                                </p>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                    ...
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <div class="menu-cate effect03 zoom-img">
                                                                                ...
                                                                                <p class="h5"><a href="category-three-columns.html">Three Columns</a>
                                                                                </p>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                        ...
                                                        <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col24 grid_24 menu-item-parent" style="">
                                                            <ul class="menu-container" style="padding:0 10px">
                                                                ...
                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-12 grid_12 omega menu-item-parent" style="">
                                                                    <ul class="menu-container">
                                                                        <li class="menu-item-text menu-item-depth-3  ">
                                                                            <p class="img-banner-menu pull-right"><img class="img-responsive" src="images/wysiwyg/em_ads01.html" alt="menu_adv" />
                                                                            </p>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                                                ...
                                                                                <div>
                                                                                    <ul class="em-catalog-navigation ">
                                                                                        ...
                                                                                        <li class="label-sale-menu">
                                                                                            <a class="em-menu-link" href="#"> <span>Game World</span> </a>
                                                                                        </li>
                                                                                        <li>
                                                    ...
                                                    <ul class="menu-container" style="background-image:url(images/menu/banner-menu01.jpg); background-repeat:no-repeat; background-position: right bottom">
                                                        <li class="menu-item-hbox menu-item-depth-1 col-menu menu_col24 grid_24 menu-item-parent" style="">
                                                            <ul class="menu-container" style="padding:0 10px">
                                                                ...
                                                                <li class="menu-item-vbox menu-item-depth-2 col-sm-24 " style=""></li>
                                                            </ul>
                                                        </li><!-- /.menu-item-hbox -->
                                                    </ul>
                                                </li><!-- /.menu-item-link -->
